...
const pt = {
  ...
  "pt5-5": {from: ["pt5-4"], sac: 2, cost: {type: "static", cost: 2.5e10}},
  "pt6-1": {from: ["pt5-2", "pt5-3"], sac: 1, cost: {type: "static", cost: 1e6}},
  "pt6-2": {from: ["pt5-3", "pt5-4"], sac: 2, cost: {type: "static", cost: 1e23}},
  "pt7-1": {from: ["pt5-1", "pt7-2"], sac: 2, cost: {type: "static", cost: 1e100}},
  "pt7-2": {from: ["pt6-1", "pt6-2"], sac: 2, cost: {type: "static", cost: 1e44}},
  "pt7-3": {from: ["pt5-5", "pt7-2"], sac: 2, cost: {type: "static", cost: 1e100}}
}
for (let id in pt) {
...
function getPTReward(id) {
  ...
  if (id == "pt2-1") {
    if (user.pp.pt.cells.includes("pt6-2")) {return Decimal.tetrate(user.pp.pt.cells.length+1, 1.25).times(multi)}
  ...
  if (id == "pt5-4") {
    ...
    return nd(bought+1).ln().plus(1).pow(Math.log10(bought+1));
  }
